...
${data.description}
## Table of Contents
${tableInstall(data.installation)}
- [Usage](#usage)
${tableContribute(data.contribute)}
${tableTest(data.tests)}
- [License](#license)
- [Questions](#questions)
...
## Questions
For any questions, please contact me at [${data.email}](mailto:${data.email}) or visit my GitHub: [${data.github}](https://github.com/${data.github}).
  `;
};
